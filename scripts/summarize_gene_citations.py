...
print("gene2pubmed", gene2pubmed.take(1))
...
print("taxid_gene_info.take(1)",taxid_gene_info.take(1))
sys.exit(1)
'''
...
print("taxid_gene_refseq_id:", taxid_gene_refseq_id.take(1))
...
print('take 1', taxid_gene_info.join(gene2pubmed).take(1))
...
print("tgip", taxid_gene_info_pubmed.take(1))
