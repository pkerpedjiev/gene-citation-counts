...
def parseInteractions(line):
    """Parses the interactions from the NCBI interactions file"""
...
if __name__ == "__main__":
    ...
    links = lines.map(lambda line: parseInteractions(line)).filter(filterx).distinct().groupByKey().cache()
